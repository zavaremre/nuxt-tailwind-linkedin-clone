<template>
  <header class="bg-white mb-2 md:mb-5">
    <div class="container">
      <section class="hidden md:flex flex-row content-between items-center w-full xs:justify-center">
        <HeaderLogo />
        <HeaderMenu />
      </section>
      <section class="flex md:hidden justify-between items-center flex-shrink-1 flex-grow-1 py-2 w-full">
        <div class="flex flex-shrink-0 flex-grow-0 w-15 h-15 px-3"><img src="~/assets/images/avatar.jpeg" class="rounded-full border-2 border-white w-9 h-9" /></div>
        <div class="w-full"><HeaderSearch /></div>
        <div class="flex justify-end">
          <button class="text-gray-400 px-5">
            <svg xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" height="24" width="24" preserveAspectRatio="none">
              <defs>
              ...
              <use href="#global-nav-icon--mercado__messaging" class="global-nav__icon-path" stroke-opacity="0" stroke="#000000" fill="#8c8c8c" />
            </svg>
          </button>
        </div>
      </section>
